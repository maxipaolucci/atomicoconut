...
var PropertiesEditComponent = /** @class */ (function () {
    ...
    PropertiesEditComponent.prototype.getProperty = function (id) {
        ...
        var newSubscription = this.propertiesService.getPropertyById(this.user.email, id).subscribe(function (property) {
            _this.property = property;
            //populate the model
            _this.model.addressData = property.address;
...
var PropertiesTableComponent = /** @class */ (function () {
    ...
    PropertiesTableComponent.prototype.ngOnInit = function () {
        ...
        this.propertiesDataSource.filterPredicate = function (data, filter) {
            var address = data.address.toLowerCase().trim();
...
var PropertiesModule = /** @class */ (function () {
    ...
    PropertiesModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [properties_dashboard_component_1.PropertiesDashboardComponent, properties_edit_component_1.PropertiesEditComponent, houses_edit_component_1.HousesEditComponent, properties_table_component_1.PropertiesTableComponent, property_selector_dialog_component_1.PropertySelectorDialogComponent],
...
var AddressAutocompleteComponent = /** @class */ (function () {
    ...
    AddressAutocompleteComponent.prototype.ngAfterViewInit = function () {
        ...
        var newSubscription2 = Observable_1.Observable.fromEvent(this.addressInputElementRef.nativeElement, 'keyup').debounceTime(50).subscribe(function (keyboardEvent) {
    ...
    ], AddressAutocompleteComponent.prototype, "addressInputElementRef", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", String)
