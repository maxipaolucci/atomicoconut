...
/* harmony import */ var _property_yields_dialog_property_yields_dialog_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../property-yields-dialog/property-yields-dialog.component */ "./src/app/modules/properties/components/property-yields-dialog/property-yields-dialog.component.ts");
...
var PropertiesEditComponent = /** @class */ (function () {
    ...
    PropertiesEditComponent.prototype.ngOnInit = function () {
        ...
        // generates a user source object from authUser from resolver
        var user$ = this.route.data.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["map"])(function (data) { return data.authUser; }));
        // generates an property id source from id parameter in url
        var id$ = this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["map"])(function (params) { return params.get('id'); }));
        // combine user$ and id$ sources into one object and start listen to it for changes
        var newSubscription = user$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["combineLatest"])(id$, function (user, id) {
            _this.user = user;
            return { user: user, propertyId: id };
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["flatMap"])(function (data) {
        ...
        this.subscription.add(newSubscription);
        // get TYPE parameter
        this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["map"])(function (params) { return params.get('type'); })).subscribe(function (type) {
    ...
    PropertiesEditComponent.prototype.openPropertyYieldsDialog = function () {
        ...
        var propertyYieldsDialogRef = this.dialog.open(_property_yields_dialog_property_yields_dialog_component__WEBPACK_IMPORTED_MODULE_11__["PropertyYieldsDialogComponent"], {
            data: {
                model: this.model,
            }
        });
